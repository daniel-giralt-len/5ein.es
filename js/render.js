		...
		function getExampleSpells (maxSpellLevel, color) {
			const LVL_TO_COLOR_TO_SPELLS = {
				2: {
					...
					A: ["veure invisibilitat", "boca màgica", "ceguera/sordera", "sleep", "detectar pensaments"],
				...
				3: {
					...
					O: ["slow", "bola de foc", "dissipar màgia", "contraconjur", "Aganazzar's scorcher|XGE", "escut"],
				...
				7: {
					...
					C: ["symbol", "simulacrum", "invertir la gravetat", "projectar imatge", "Mà d'en Bigby", "mental prison|XGE", "aparentar"],

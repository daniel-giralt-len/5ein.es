		...
		function getExampleSpells (maxSpellLevel, color) {
			const LVL_TO_COLOR_TO_SPELLS = {
				...
				5: {
					...
					O: ["hold monster", "immolation|XGE", "wall of fire", "invisibilitat superior", "porta dimensional"],
				...
				6: {
					...
					A: ["scrying", "Rary's telepathic bond", "Dansa Irresistible de l'Otto", "legend lore", "hold monster", "dream"],
				},
				7: {

		...
		function getExampleSpells (maxSpellLevel, color) {
			const LVL_TO_COLOR_TO_SPELLS = {
				...
				5: {
					...
					Z: ["cop del vent d'acer|XGE", "controlar el temps", "controlar el vent|XGE", "watery sphere|XGE", "esfera de tempesta|XGE", "tidal wave|XGE"],
				...
				7: {
					...
					Z: ["whirlwind|XGE", "llamp en cadena", "escampar|XGE", "teleportació", "desintegrar", "llampec"],

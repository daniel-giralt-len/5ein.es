		...
		function getExampleSpells (maxSpellLevel, color) {
			const LVL_TO_COLOR_TO_SPELLS = {
				...
				3: {
					...
					O: ["alentir", "bola de foc", "dissipar màgia", "contraconjur", "Aganazzar's scorcher|XGE", "escut"],
				...
				5: {
					...
					S: ["cone of cold", "tempesta de gel", "cercle de teleportació", "skill empowerment|XGE", "creació", "Santuari Privat d'en Mordenkainen"],
				},
				6: {

...
Purse. Melee Weapon Attack: +14 a impactar, 10 peus d'abast, un objectiu. Hit: 19 (3d8 + 6) dany contundent plus 18 (4d8) radiant damage.
...
>- **Disrupt Life (Costs 3 Actions).** Each non-undead creature within 20 feet of the lich must make a DC 18 Constitution saving throw against this magic, taking 21 (6d6) necrotic damage on a failed save, ; si supera, en rep la meitat.
>
>`;
// endregion
...
A Nivells Superiors. Quan llances aquest conjur emprant una ranura de nivell 2 o superior, the damage increases by 1d8 per cada nivell per sobre d'1.`;
// endregion

...
At will: fascinar persona, detectar màgia, dissipar màgia, fabricate (Mammon can create valuable objects), escalfar el metall, aura màgica de l'arcanista
...
Duration: Instantani
You hurl a 4-inch-diameter sphere of energy at a creature que puguis veure a l'abast. You choose acid, cold, fire, lightning, poison, or thunder for the type of orb you create, and then make a atac màgic a distància against the target. If the attack hits, the creature takes 3d8 damage of the type you chose.

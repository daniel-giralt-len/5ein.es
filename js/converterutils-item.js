...
class ReqAttuneTagTag {
	static _checkAndTag (obj, opts, isAlt) {
		...
		req = req.replace(/(?:a creature that can )?speak \b(Abyssal|Aquan|Auran|Celestial|Common|Deep Speech|Draconic|Druidic|Nan|Elvish|Giant|Gnomesc|Goblin|Halfling|Ignan|Infernal|Orc|Primordial|Sylvan|Terran|Argot de Lladres|Undercommon)\b/g, (...m) => {

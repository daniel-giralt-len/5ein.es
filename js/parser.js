...
Parser.getTimeToFull = function (time) {
	return `${time.number ? `${time.number} ` : ""}${time.unit === "bonus" ? "acció bonus" : time.unit}${time.number > 1 ? "s" : ""}`;
};
 ...
 *
 * @param sp a spell
 * @param subclassLookup Data loaded from `generated/gendata-subclass-lookup.json`. Of the form: `{PHB: {Barbarian: {PHB: {Berserker: "Sender dels Bersèrker"}}}}`
...
Parser.SP_TIME_TO_FULL = {
	[Parser.SP_TM_ACTION]: "Action",
	[Parser.SP_TM_B_ACTION]: "Acció Bonus",
	[Parser.SP_TM_REACTION]: "Reaction",
...
Parser.MON_TYPE_TO_PLURAL[TP_ABERRATION] = "aberracions";
Parser.MON_TYPE_TO_PLURAL[TP_BEAST] = "beasts";
Parser.MON_TYPE_TO_PLURAL[TP_CELESTIAL] = "celestials";
Parser.MON_TYPE_TO_PLURAL[TP_CONSTRUCT] = "constructes";
Parser.MON_TYPE_TO_PLURAL[TP_DRAGON] = "dracs";
Parser.MON_TYPE_TO_PLURAL[TP_ELEMENTAL] = "elementals";
Parser.MON_TYPE_TO_PLURAL[TP_FEY] = "fates";
Parser.MON_TYPE_TO_PLURAL[TP_FIEND] = "infernals";
Parser.MON_TYPE_TO_PLURAL[TP_GIANT] = "gegants";
Parser.MON_TYPE_TO_PLURAL[TP_HUMANOID] = "humanoides";
Parser.MON_TYPE_TO_PLURAL[TP_MONSTROSITY] = "monstrositats";
Parser.MON_TYPE_TO_PLURAL[TP_OOZE] = "llims";
Parser.MON_TYPE_TO_PLURAL[TP_PLANT] = "plantes";
Parser.MON_TYPE_TO_PLURAL[TP_UNDEAD] = "no-morts";
...
Parser.SIZE_ABV_TO_FULL[SZ_FINE] = "Lil·liputenc";
Parser.SIZE_ABV_TO_FULL[SZ_DIMINUTIVE] = "Ínfim";
Parser.SIZE_ABV_TO_FULL[SZ_TINY] = "Diminut";
Parser.SIZE_ABV_TO_FULL[SZ_SMALL] = "Petit";
Parser.SIZE_ABV_TO_FULL[SZ_MEDIUM] = "Mitjà";
Parser.SIZE_ABV_TO_FULL[SZ_LARGE] = "Gran";
Parser.SIZE_ABV_TO_FULL[SZ_HUGE] = "Enorme";
Parser.SIZE_ABV_TO_FULL[SZ_GARGANTUAN] = "Titànic";
...
SRC_UA2021FF = `${SRC_UA_PREFIX}2021FolkOfTheTerra Fata`;
...
Parser.SOURCE_JSON_TO_FULL[SRC_SADS] = "Sapphire Anniversary Set de daus";
...
Parser.SOURCE_JSON_TO_FULL[SRC_UA2021FF] = `${UA_PREFIX}2021 Folk of the Terra Fata`;
...
Parser.SKILL_JSON_TO_FULL = {
	...
	"Investigation": [
		"When you look around for clues and make deductions based on those clues, you make an Intel·ligència (Investigation) check. You might deduce the location of a hidden object, discern from the appearance of a wound what kind of weapon dealt it, or determine the weakest point in a tunnel that could cause it to collapse. Poring through ancient scrolls in search of a hidden fragment of knowledge might also call for an Intel·ligència (Investigation) check.",
	],
	"Medicine": [

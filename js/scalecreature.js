...
(typeof module !== "undefined" ? global : window).ScaleCreature = {
	...
	_armorClass: {
		...
		_getAdjustedAcItem_getAdjusted (mon, crIn, crOut, acItem, iter) {
			...
			const handleShield = () => {
				...
				const DUAL_SHIELD_AC = 3; // dual-wield shields is 3 AC, according to VGM's Gegant del Foc Dreadnought
	...
	_wepThrown: ["destral de mà", "javelina", "martell lleuger", "Llança", "trident", "net"],

...
class PageFilterBestiary extends PageFilter {
	...
	constructor () {
		...
		this._traitFilter = new Filter({
			header: "Traits",
			items: [
				"Agressivitat", "Ambusher", "Amorphous", "Amfibi", "Debilitat Antimàgica", "Brute", "Carregar", "Damage Absorption", "Death Burst", "Devil's Sight", "Falsa Aparença", "Ascendència Faèrica", "Passar Volant", "Hold Breath", "Illumination", "Forma Immutable", "Moviment Incorpori", "Sentits Aguts", "Resistències Llegendàries", "Light Sensitivity", "Resistència a la Màgia", "Magic Weapons", "Pack Tactics", "Abraonar", "Rampage", "Reckless", "Regeneració", "Rejuvenation", "Shapechanger", "Siege Monster", "Sneak Attack", "Grimpat d'Aranya", "Sensible al Sol", "Immunitat a Expulsar", "Resistir l'Expulsió", "Resiliència No-morta", "Water Breathing", "Web Sense", "Web Walker",
			],
		});

...
class PageFilterBestiary extends PageFilter {
	...
	constructor () {
		...
		this._traitFilter = new Filter({
			header: "Traits",
			items: [
				"Agressivitat", "Emboscar", "Amorf", "Amfibi", "Debilitat Antimàgica", "Brute", "Carregar", "Absorbir Dany", "Cadàver Detonant", "Ulls de Diables", "Falsa Aparença", "Ascendència Faèrica", "Passar Volant", "Aguantar la Respiració", "Il·luminació", "Forma Immutable", "Moviment Incorpori", "Sentits Aguts", "Resistències Llegendàries", "Sensible a la Llum", "Resistència a la Màgia", "Armament Màgic", "Estratègies de Manada", "Abraonar", "Enfurismar", "Reckless", "Regeneració", "Rejovenir", "Canviaformes", "Monstre de Setge", "Atac Furtiu", "Grimpat d'Aranya", "Sensible al Sol", "Immunitat a Expulsar", "Resistir l'Expulsió", "Resiliència No-morta", "Respirar sota l'aigua", "Sentir el Tirarany", "Web Walker",
			],
		});

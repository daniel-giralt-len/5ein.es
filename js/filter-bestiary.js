...
class PageFilterBestiary extends PageFilter {
	...
	constructor () {
		...
		this._traitFilter = new Filter({
			header: "Traits",
			items: [
				"Aggressive", "Ambusher", "Amorphous", "Amfibi", "Antimagic Susceptibility", "Brute", "Carregar", "Damage Absorption", "Death Burst", "Devil's Sight", "False Appearance", "Ascendència Faèrica", "Passar Volant", "Hold Breath", "Illumination", "Forma Immutable", "Moviment Incorpori", "Sentits Aguts", "Resistència Llegendàrias", "Light Sensitivity", "Magic Resistance", "Magic Weapons", "Pack Tactics", "Abraonar", "Rampage", "Reckless", "Regeneració", "Rejuvenation", "Shapechanger", "Siege Monster", "Sneak Attack", "Grimpat d'Aranya", "Sensible al Sol", "Immunitat a Expulsar", "Turn Resistance", "Resiliència No-morta", "Water Breathing", "Web Sense", "Web Walker",
			],
		});
